...
export default function ProfilePage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (email === "admin@mangosync.com" && password === "admin") {
      sessionStorage.setItem("mangoSyncAuth", "true");
      setIsLoggedIn(true);
      window.dispatchEvent(new Event("mangoSyncAuthChange"));
      showToast("Sesión iniciada con éxito", "success");
    } else {
      setLoginError("Credenciales incorrectas. Intenta con admin@mangosync.com / admin");
    }
  };
        ...
        <div className="min-h-[calc(100vh-140px)] bg-slate-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          <Card className="w-full max-w-md border-none shadow-xl bg-white rounded-3xl overflow-hidden">
            <CardHeader className="bg-gradient-to-br from-amber-500 via-orange-500 to-emerald-600 text-white text-center p-8 relative">
              ...
              <CardTitle className="text-2xl font-extrabold tracking-tight">Acceso de Administrador</CardTitle>
              <CardDescription className="text-amber-100/90 mt-1 text-xs">
                Ingresa a tu cuenta de MangoSync para administrar los productos.
              </CardDescription>
            </CardHeader>
              ...
              <CardContent className="p-8 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="admin@mangosync.com"
                    value={email}
                ...
                <div className="text-xs text-slate-400 bg-slate-50 p-3 rounded-xl text-center leading-relaxed">
                  💡 **Credenciales demo:**  
                  Correo: <span className="font-semibold text-slate-600">admin@mangosync.com</span>  
                  Contraseña: <span className="font-semibold text-slate-600">admin</span>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left space-y-2">
                  <div className="flex items-center justify-center md:justify-start gap-3">
                    <h1 className="text-3xl font-extrabold tracking-tight font-sans">Mateo Valenzuela</h1>
                    <span className="px-2.5 py-0.5 text-xs font-semibold bg-emerald-900/60 rounded-full border border-emerald-400">Propietario</span>
                  </div>
                  <p className="text-amber-100 font-medium text-sm md:text-base max-w-xl">
                    Cultivando mangos orgánicos de calidad premium y elaborando delicias artesanales galardonadas en Sinaloa desde 2012.
                  </p>
                </div>
              </div>
